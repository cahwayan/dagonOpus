...
public final class CQuestaoProva extends CQuestao implements Questao, Exercicio {
    ...
    public static CQuestaoProva novaQuestaoProva(int moduloAtual, int etapaAtual, int questaoAtual) {
        CQuestaoProva questao = new CQuestaoProva();

...
public class Licao4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_modulo1_etapa3_licao4, container, false);
    ...
    private int verificaAlternativa(int alternativa) {
        switch(alternativa) {
            case 1: return DB_PROGRESSO.verificaPergunta(1,3,2,1);
            case 2: return DB_PROGRESSO.verificaPergunta(1,3,2,2);
            case 3: return DB_PROGRESSO.verificaPergunta(1,3,2,3);
            case 4: return DB_PROGRESSO.verificaPergunta(1,3,2,4);
        }
        return 0;
    }

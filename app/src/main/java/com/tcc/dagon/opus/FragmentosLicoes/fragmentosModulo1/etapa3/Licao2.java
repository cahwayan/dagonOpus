...
public class Licao2 extends Fragment {
    ...
    private void accessViews() {
        ...
        alternativa1 = (RadioButton) rootView.findViewById(R.id.Modulo1Etapa3Pergunta1Alternativa1);
        alternativa2 = (RadioButton) rootView.findViewById(R.id.Modulo1Etapa3Pergunta1Alternativa2);
        alternativa3 = (RadioButton) rootView.findViewById(R.id.Modulo1Etapa3Pergunta1Alternativa3);
        alternativa4 = (RadioButton) rootView.findViewById(R.id.Modulo1Etapa3Pergunta1Alternativa4);
        // PEGANDO O RADIOGROUP DO LAYOUT
        containerRadioButtons = (RadioGroup) rootView.findViewById(R.id.radioGroupModulo1Etapa3Licao2);
    ...
    private void avancarLicao() {
        ...
        if(DB_PROGRESSO.verificaProgressoLicao(1,3) <= 1) {
    ...
    private int verificaAlternativa(int alternativa) {
        switch(alternativa) {
            case 1: return DB_PROGRESSO.verificaPergunta(1,3,1,1);
            case 2: return DB_PROGRESSO.verificaPergunta(1,3,1,2);
            case 3: return DB_PROGRESSO.verificaPergunta(1,3,1,3);
            case 4: return DB_PROGRESSO.verificaPergunta(1,3,1,4);
        }
        return 0;
    }

...
public class Licao1 extends Licao {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        super.viewRoot = inflater.inflate(R.layout.fragment_modulo1_etapa7_licao1,container,false);
        this.accessViews();
    ...
    protected void accessViews() {
        ...
        imagem1 = (ImageView) viewRoot.findViewById(R.id.imagem1Modulo1Etapa7Licao1);
        imagem2 = (ImageView) viewRoot.findViewById(R.id.imagem2Modulo1Etapa7Licao1);
        super.accessViews();
    }
}

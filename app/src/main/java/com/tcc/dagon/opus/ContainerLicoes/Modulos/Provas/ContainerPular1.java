...
import com.tcc.dagon.opus.Adapters.Provas.AdapterPular1;
...
public class ContainerPular1 extends ContainerProva {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.container_pular1);
    ...
    protected void accessViews() {
        ...
        mViewPager.setAdapter(new AdapterPular1(getSupportFragmentManager(),

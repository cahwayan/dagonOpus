package com.tcc.dagon.opus.FragmentosLicoes.fragmentosModulo6.etapa6;
...
public class Questao1 extends Questao {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo6_etapa6_licao2, container, false);
    ...
    protected void accessViews() {
        ...
        mViewPager = ((ContainerModulo6Etapa6)getActivity()).getPager();
        tabStrip   = ((ContainerModulo6Etapa6)getActivity()).getTabStrip();
        mTabLayout = ((ContainerModulo6Etapa6)getActivity()).getmTabLayout();

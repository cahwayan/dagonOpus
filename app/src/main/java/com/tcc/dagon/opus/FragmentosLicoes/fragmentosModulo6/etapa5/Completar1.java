...
public class Completar1 extends Completar {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo6_etapa5_licao4, container, false);
        super.moduloAtual = 6;
        super.etapaAtual  = 5;
        //TRAZENDO AS VIEWS
        accessViews();
    ...
    protected void accessViews() {
        ...
        respostasCertas = new String[]{"classe", "caneta", "metodo", "tampar"};
        respostasCertasAcentuadas = new String[]{"classe", "caneta", "metodo", "tampar"};

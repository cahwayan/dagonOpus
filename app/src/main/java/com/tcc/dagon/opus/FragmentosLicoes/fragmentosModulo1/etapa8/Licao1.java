...
public class Licao1 extends Licao {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        super.viewRoot = inflater.inflate(R.layout.fragment_modulo1_etapa8_licao1,container,false);
        this.accessViews();
        super.listeners();
    ...
    protected void accessViews() {
        ...
        imagem1 = (ImageView) viewRoot.findViewById(R.id.imagem1Modulo1Etapa8Licao1);
        super.accessViews();
    }
}

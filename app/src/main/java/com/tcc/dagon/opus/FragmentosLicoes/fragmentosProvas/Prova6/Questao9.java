 ...
 */
public class Questao9 extends QuestaoProva {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.etapaAtual = 10;
        // NÚMERO DA PERGUNTA
        super.questaoAtual = 9;

        // GUARDANDO O LAYOUT EM UMA VARIÁVEL PARA RETORNAR NO FIM DO MÉTODO
        super.rootView = inflater.inflate(R.layout.fragment_modulo6_prova_questao9, container, false);

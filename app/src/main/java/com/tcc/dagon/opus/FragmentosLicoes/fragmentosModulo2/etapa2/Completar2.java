...
public class Completar2 extends Completar {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo2_etapa2_licao4, container, false);
        super.moduloAtual = 2;
        super.etapaAtual  = 2;
        //TRAZENDO AS VIEWS
        accessViews();
    ...
    protected void accessViews() {
        ...
        linha2Palavra1 = (EditText) rootView.findViewById(R.id.Modulo2Etapa2Pergunta2Linha2Palavra1);
        linha2Palavra2 = (EditText) rootView.findViewById(R.id.Modulo2Etapa2Pergunta2Linha2Palavra2);
        ...
        respostasCertasAcentuadas = new String[]{"a", "b"};
    }

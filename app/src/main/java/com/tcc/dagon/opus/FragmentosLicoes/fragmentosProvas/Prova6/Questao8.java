 ...
 */
public class Questao8 extends CompletarProva {

    private EditText palavra1, palavra2, palavra3;

    private static final int tamanhoPalavra1 = 3;
    private static final int tamanhoPalavra2 = 4;
    private static final int tamanhoPalavra3 = 3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo6_prova_questao8, container, false);
    ...
    protected void listeners() {
        ...
        adicionarClickListenerEditText(tamanhoPalavra2, palavra2, palavra3);
        adicionarClickListenerEditText(tamanhoPalavra3, palavra3, null);

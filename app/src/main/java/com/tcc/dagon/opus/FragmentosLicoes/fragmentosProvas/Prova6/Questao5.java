...
public class Questao5 extends CompletarProva {
    ...
    private static final int tamanhoPalavra2 = 7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo6_prova_questao5, container, false);
    ...
    protected void accessViews() {
        ...
        respostasCertas = new String[]{"metodo", "pedalar"};

        respostasCertasAcentuadas = new String[]{"metodo", "pedalar"};

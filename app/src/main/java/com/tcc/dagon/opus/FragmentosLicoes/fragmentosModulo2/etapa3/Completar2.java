...
public class Completar2 extends Completar {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo2_etapa3_licao6, container, false);
        super.moduloAtual = 2;
        super.etapaAtual  = 3;
        //TRAZENDO AS VIEWS
        accessViews();
    ...
    protected void accessViews() {
        ...
        linha2Palavra1 = (EditText) rootView.findViewById(R.id.Modulo2Etapa3Pergunta3Linha2Palavra1);
        linha4Palavra1 = (EditText) rootView.findViewById(R.id.Modulo2Etapa3Pergunta3Linha4Palavra1);

        // INSTANCIANDO A LISTA
        listaEditTexts = new ArrayList<>();

        // ENCHENDO O ARRAY DE EDIT TEXTS COM AS EDIT TEXTS
        linhasCompletar = new EditText[] {linha2Palavra1, linha4Palavra1};
        ...
        respostasCertas = new String[]{"contador", "contador"};
        respostasCertasAcentuadas = new String[]{"contador", "contador"};
    }

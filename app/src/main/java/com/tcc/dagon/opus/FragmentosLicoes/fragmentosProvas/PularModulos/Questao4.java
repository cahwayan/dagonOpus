 ...
 */
public class Questao4 extends QuestaoPular {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_pular1_questao4, container, false);
    ...
    protected void accessViews() {
        ...
        alternativa1 = (RadioButton) rootView.findViewById(R.id.ProvaModulo1Pergunta4Alternativa1);
        alternativa2 = (RadioButton) rootView.findViewById(R.id.ProvaModulo1Pergunta4Alternativa2);
        alternativa3 = (RadioButton) rootView.findViewById(R.id.ProvaModulo1Pergunta4Alternativa3);
        alternativa4 = (RadioButton) rootView.findViewById(R.id.ProvaModulo1Pergunta4Alternativa4);

        // PEGANDO O RADIOGROUP DO LAYOUT
        containerRadioButtons = (RadioGroup) rootView.findViewById(R.id.radioGroupProvaModulo1Pergunta4);

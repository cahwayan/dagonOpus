...
public class Questao3 extends Questao {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo1_etapa6_licao4, container, false);
    ...
    protected void accessViews() {
        ...
        alternativa1 = (RadioButton) rootView.findViewById(R.id.Modulo1Etapa6Pergunta3Alternativa1);
        alternativa2 = (RadioButton) rootView.findViewById(R.id.Modulo1Etapa6Pergunta3Alternativa2);
        alternativa3 = (RadioButton) rootView.findViewById(R.id.Modulo1Etapa6Pergunta3Alternativa3);
        alternativa4 = (RadioButton) rootView.findViewById(R.id.Modulo1Etapa6Pergunta3Alternativa4);

        // PEGANDO O RADIOGROUP DO LAYOUT
        containerRadioButtons = (RadioGroup) rootView.findViewById(R.id.radioGroupModulo1Etapa6Licao4);

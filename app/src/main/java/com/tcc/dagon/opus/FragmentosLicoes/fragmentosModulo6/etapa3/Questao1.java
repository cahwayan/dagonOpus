package com.tcc.dagon.opus.FragmentosLicoes.fragmentosModulo6.etapa3;
...
public class Questao1 extends Questao {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo6_etapa3_licao2, container, false);
    ...
    protected void accessViews() {
        ...
        mViewPager = ((ContainerModulo6Etapa3)getActivity()).getPager();
        tabStrip   = ((ContainerModulo6Etapa3)getActivity()).getTabStrip();
        mTabLayout = ((ContainerModulo6Etapa3)getActivity()).getmTabLayout();

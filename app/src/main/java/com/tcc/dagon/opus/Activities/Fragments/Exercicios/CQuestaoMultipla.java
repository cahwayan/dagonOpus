...
public class CQuestaoMultipla extends CQuestao implements Exercicio, Questao {
    ...
    public static CQuestaoMultipla novaQuestaoMultipla(int moduloAtual, int etapaAtual, int questaoAtual) {
        CQuestaoMultipla questao = new CQuestaoMultipla();

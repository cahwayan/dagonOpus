...
public abstract class CExercicio extends Fragment implements Exercicio {
    ...
    public void initAnimationAnswer(ImageView image) {
    ...
    public void hideUnnecessaryView(View view) {
        if(view != null) {
            view.setVisibility(View.GONE);
        }
    }

    public void unhideView(View view) {
        if(view != null) {

...
public class QuestaoMultipla extends Questao {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        setModuloAtual(getArguments().getInt("moduloAtual", 0));
        setEtapaAtual(getArguments().getInt("etapaAtual", 0));
        setQuestaoAtual(getArguments().getInt("questaoAtual", 0));

        configurarQuestao(getModuloAtual(), getEtapaAtual(), getQuestaoAtual());

        rootView = inflater.inflate(R.layout.activity_questao_multipla_escolha, container, false);
            ...
            public void onClick(View v) {
                ...
                for(int i = 0; i <= 3; i++) {
                    ...
                    if(isAlternativaChecked[i]) {
                        ...
                        respostas[i] = verificaAlternativa(contadorAlternativa);
    ...
    protected void carregarPergunta() {
        ...
        this.alternativa1.setText(getDB_PROGRESSO().puxarAlternativa(getModuloAtual(), getEtapaAtual(), getQuestaoAtual(), 1));
        this.alternativa2.setText(getDB_PROGRESSO().puxarAlternativa(getModuloAtual(), getEtapaAtual(), getQuestaoAtual(), 2));
        this.alternativa3.setText(getDB_PROGRESSO().puxarAlternativa(getModuloAtual(), getEtapaAtual(), getQuestaoAtual(), 3));
        this.alternativa4.setText(getDB_PROGRESSO().puxarAlternativa(getModuloAtual(), getEtapaAtual(), getQuestaoAtual(), 4));
    }

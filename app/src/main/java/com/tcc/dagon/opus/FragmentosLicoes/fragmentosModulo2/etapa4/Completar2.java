...
public class Completar2 extends Completar {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo2_etapa4_licao4, container, false);
        super.moduloAtual = 2;
        super.etapaAtual  = 4;
        //TRAZENDO AS VIEWS
        accessViews();
    ...
    protected void accessViews() {
        ...
        linha2Palavra1 = (EditText) rootView.findViewById(R.id.Modulo2Etapa4Pergunta2Linha2Palavra1);
        linha2Palavra2 = (EditText) rootView.findViewById(R.id.Modulo2Etapa4Pergunta2Linha2Palavra2);
        linha2Palavra3 = (EditText) rootView.findViewById(R.id.Modulo2Etapa4Pergunta2Linha2Palavra3);
        ...
        respostasCertas = new String[]{"para", "0", "2"};
        respostasCertasAcentuadas = new String[]{"para", "0", "2"};

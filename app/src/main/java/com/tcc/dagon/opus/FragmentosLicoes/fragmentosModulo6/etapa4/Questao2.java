...
public class Questao2 extends Questao {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        super.rootView = inflater.inflate(R.layout.fragment_modulo6_etapa4_licao4, container, false);
    ...
    protected void accessViews() {
        ...
        tabStrip   = ((ContainerModulo6Etapa4)getActivity()).getTabStrip();
        mTabLayout = ((ContainerModulo6Etapa4)getActivity()).getmTabLayout();
